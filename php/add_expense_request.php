...
$stmt = $conn->prepare("
  INSERT INTO expense_requests 
    (project_id, amount, request_date, required_date, sheet_id, approver1_id, approver2_id, user_id)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?)
");

$stmt->bind_param('dsssiiii', $project_id, $amount, $request_date, $required_date, $sheet_id, $approver1_id, $approver2_id, $user_id);
