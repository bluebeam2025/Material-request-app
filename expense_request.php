...
<head>
    ...
    <style>
        ...
        .open-btn {
            ...
            border:none; border-radius:4px; font-size:0.85rem; cursor:pointer; text-decoration:none;
        }
...
<div class="main-content">
    ...
    <div id="sheet-section">
        <table>
            ...
            <tbody>
                <?php if ($expenseSheets): $sn = 1; foreach ($expenseSheets as $e): ?>
                    <tr>
                        <td><?= $sn++ ?></td>
    ...
    <div id="request-section" style="display:none">
        <!-- Future: We will add Request History List here -->
...
<div class="modal" id="requestModal"><div class="modal-content">
    ...
    <form method="POST" action="php/add_expense_request.php">
        ...
        <select name="sheet_id">
            ...
            <?php foreach ($expenseSheets as $e): ?>
